...
export default function DashboardHeader({
  ...
  return (
    <div className="flex justify-end items-center py-[13px] h-[60px] pl-10 pr-3 md:py-4 md:h-[70px] lg:justify-between md:pr-10 lg:pr-20 bg-white_FFFFFF border-b border-gray_D9D9D9">
